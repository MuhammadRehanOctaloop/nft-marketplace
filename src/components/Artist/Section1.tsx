  ...
  return (
    <div className="mt-20 m-10">
          <div className="relative flex flex-col lg:flex-row items-center justify-between max-w-[1320px] mx-auto w-full gap-10">
            {/* Left Image Section */}
            <div className="relative flex justify-center p-4 items-center bg-white rounded-3xl shadow-md w-full sm:w-[80%] md:w-[60%] lg:w-auto">
              <Image
            ...
            <div className="flex flex-col justify-center w-full max-w-[674px] lg:w-[674px] mx-4">
              {/* Title */}
              <h1 className="text-[#2B2B2B] font-apex font-normal text-[48px] md:text-[64px] lg:text-[64px] leading-tight text-center md:text-left lg:text-left">
              WONDERFUL ARTWORK
              </h1>
