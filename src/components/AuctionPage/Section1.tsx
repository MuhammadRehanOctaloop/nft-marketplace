...
<div className="flex flex-col lg:flex-row max-w-[1316px] mx-auto mb-10 gap-5 items-center lg:items-end lg:justify-between">
  ...
  <div className="flex items-center my-auto justify-center lg:justify-end w-[200px] h-[32px] font-roboto font-medium text-[12px] leading-[14.06px] text-[#7D7D7D] text-center gap-2">
